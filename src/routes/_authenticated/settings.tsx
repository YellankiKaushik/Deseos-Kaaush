...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AspireList — Your personal acquisition dashboard" },
      {
        name: "description",
        content:
          "Save anything you want from anywhere on the web, plan the purchase, track your savings, and keep a record of what you achieved.",
      },
